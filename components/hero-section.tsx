export function HeroSection() {
  return (
    <section className="min-h-[80vh] sm:min-h-[70vh] md:min-h-[60vh] flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-purple-50 to-pink-50">
