...
const translations = {
	fr: {
		...
		about_p2:
			"Mon profil allie une double expertise : la théorie par mon master en Innovation en Agro alimentaire (à l'ESIAB) et la pratique par mon CAP pâtisserie + mon expérience terrain en production (via mon poste de chef de ligne chez Erhard ou les industrialisations produits réalisées chez Pasquier ou Materne).",
		about_p3:
