...
const translations = {
  fr: {
    ...
    hero_subtitle: "Je suis chef de projet en Recherche et Développement en Agro-alimentaire et voici qui je suis...",
  ...
  en: {
    ...
    hero_subtitle: "I'm a project manager in Food Research and Development and here's who I am...",
